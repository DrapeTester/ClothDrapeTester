...
from .effnet_util import (round_filters, round_repeats, drop_connect,
...
torch.manual_seed(0)
    ...
    def __init__(self,
                 ...
                 blocks_args=None,
                 global_params=None):
        super().__init__("effnet", input_mean, input_std, output_mean,
        ...
        # Stem
        in_channels = num_of_input  # rgb; it can be changed afterwards by "change_inplanes"
        ...
        self._fc = nn.Linear(out_channels, num_of_output)
...
torch.manual_seed(0)
    ...
    @classmethod
    def from_name(cls, model_name, input_mean, input_std, output_mean,
                  output_std, num_of_input, num_of_output, dropout,
                  **override_params):
        ...
        blocks_args, global_params = get_model_params(model_name,
                                                      override_params)
        model = cls(input_mean, input_std, output_mean, output_std,
                    num_of_input, num_of_output, dropout, blocks_args,
                    global_params)
        # model._change_in_channels(num_of_input)
        # model._change_out_channels(num_of_output)
        return model
    ...
    def _change_out_channels(self, num_of_output):
        if num_of_output != 3:
            out_channels = round_filters(1280, self._global_params)
...
def make_effnetb0(input_mean, input_std, output_mean, output_std, num_of_input,
